...
// Modify here: Global variable to hold the string to send
char *send_string = "ICMP ";
size_t send_string_len = 5; // Length of the string
...
int main() {
    stdio_init_all();
    puts("\nI2C slave example - sending string from variable");
...
// static const uint I2C_SLAVE_SDA_PIN = PICO_DEFAULT_I2C_SDA_PIN; // 4
// static const uint I2C_SLAVE_SCL_PIN = PICO_DEFAULT_I2C_SCL_PIN; // 5
// // Slave context with a fixed message to send
// static struct {
//     uint8_t mem[24];
//     uint8_t mem_address;
// } context = {
//     .mem = {'I', 'C', 'M', 'P'}, // The message to send
//     .mem_address = 0
// };
// // Handler for I2C communication
// static void i2c_slave_handler(i2c_inst_t *i2c, i2c_slave_event_t event) {
...
// int main() {
//     stdio_init_all();
//     puts("\nI2C slave example - sending ICMP");
